...
async def stop(client, user, frwd_id):
   ...
   temp.CANCEL[frwd_id] = False  # Clear task-specific cancel flag
...
async def terminate_frwding(bot, m):
    ...
    if frwd_id:
        ...
        # Fallback for older buttons without frwd_id
        await m.answer("Unable to identify task. Please start a new task.", show_alert=True)
